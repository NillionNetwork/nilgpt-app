...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        'flex h-10 flex-row items-center justify-between gap-0.5 rounded-md bg-transparent py-2 sm:h-9',
        Platform.select({
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      <View className="absolute right-2 top-1/2 flex size-3.5 items-center justify-center self-center">
